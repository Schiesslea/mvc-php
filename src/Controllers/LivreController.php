...
class LivreController
{
    ...
    public function creer() {
        ...
        if ($_SERVER["REQUEST_METHOD"] === "POST") {
            ...
            if (empty($nombre_pages_livre) || !is_numeric($nombre_pages_livre) || (int)$nombre_pages_livre <= 0) {
                $erreurs['nombre_pages_livre'] = "Le nombre de pages est obligatoire et doit être un entier positif";
            }
            ...
            if (empty($erreurs)) {
                ...
                $livre->setNbPages((int)$nombre_pages_livre);
