...
<form action="/index.php?route=livre-creer" method="post">
    <ul>
        <li>
        ...
        <li>
            ...
            <input type="number" id="nombre_pages_livre" name="nombre_pages_livre" required />
        </li>
        <li>
            <label for="auteur_livre">Auteur :</label>
            <input type="text" id="auteur_livre" name="auteur_livre" required />
        </li>
    </ul>
    <div class="button">
